...
for i in range(max_iterations):
    if (i % plot_interval == 0):
        ...
        for point in current_data:
            if len(point) >= 3 and 0 <= point[0] <= 30:
                ...
                # Calculate z_coordinates based on the loading of a new plane and the degree it moved up
                z_coordinates.append(point[2] * 0.3048 + np.radians(i))  
